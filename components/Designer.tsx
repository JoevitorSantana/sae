...
function Designer() {
    ...
    const { elements, addElement, selectedElement, removeElement, setSelectedElement } = useDesigner();
            ...
            >
                ...
                >
                    {!droppable.isOver && elements.length === 0 && (
                        <p className="text-3xl text-muted-foreground flex flex-grow items-center font-bold">Arraste aqui</p>
                    )}
            ...
            {mouseIsOver && (
                <>
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse">
                        <p className="text-muted-foreground text-sm text-center">Arraste para mover, ou clique para ver propriedades</p>
                    </div>
                </>
            )}
